...
- Avoid using bash commands to read/write to files whenever possible, avoid using scripting such as python, node, etc. to read/write files if possible, prefer directly reading or writing. 
